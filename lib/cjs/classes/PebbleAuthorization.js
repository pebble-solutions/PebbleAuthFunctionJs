...
exports.PebbleAuthorization = void 0;
 ...
 */
class PebbleAuthorization extends pebble_auth_client_1.PebbleAuthToken {
    /**
    ...
    getToken() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.exp >= (new Date().getTime() / 1000)) {
                const authResponse = yield (0, fetchAuthTokenFunction_1.fetchAuthToken)(this.options);
...
exports.PebbleAuthorization = PebbleAuthorization;
