...
const fetchAuthTokenFunction_js_1 = require("./functions/fetchAuthTokenFunction.js");
...
const pebbleAuthentification = (options, appFirebase) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const authResponse = yield (0, fetchAuthTokenFunction_js_1.fetchAuthToken)(pebbleOptions);
